def Graphique_Simple(x, y,x_label = "",y_label = "", graph_name = "", linestyle = 'b-'):
    import numpy as np
...
def Graphique_Double_Echelle(x, y1, y2,x_label = "",y1_label = "", y2_label = "", graph_name = "", linestyle1 = '-', linestyle2 = '-', color1 = 'b', color2 = 'g'):
    import numpy as np
    import matplotlib.pyplot as plt
